...
use noir_wallet_lib::{btc, cosmos, eth};
...
#[tauri::command]
fn derive(mnemonic: String, path: String, hrp: String) -> Response<(KeyPair, String, String, String)> {
  let inner_derive = |mnemonic: &String, path: &String| -> Result<(KeyPair, String, String, String), NoirError> {
